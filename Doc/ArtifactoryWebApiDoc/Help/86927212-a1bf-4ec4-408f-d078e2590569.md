...
**C++**
``` C++
public ref class Checksums
```
**F#**
``` F#
type Checksums = class end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  Checksums</td></tr>
</table>
