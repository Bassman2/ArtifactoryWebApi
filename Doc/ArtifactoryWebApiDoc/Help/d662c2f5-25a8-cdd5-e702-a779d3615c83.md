...
**VB**
``` VB
Public ReadOnly Property UsedSpaceInBytes As Long?
	Get
```
**C++**
``` C++
public:
property Nullable<long long> UsedSpaceInBytes {
	Nullable<long long> get ();
}
```
**F#**
``` F#
member UsedSpaceInBytes : Nullable<int64> with get
```
